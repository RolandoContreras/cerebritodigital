                                ...
                                <div class="form-group"> 
                                    <div class="col-lg-12"> 
                                        <label class="control-label"><br/>
                                            <a onclick='create_invoice("<?php echo $value->kit_id;?>","<?php echo $value->price;?>");' <?php echo $kit_id >= $value->kit_id?"disabled":"";?> style="cursor: pointer;  color: rgb(0,0,255);" >Si ya realizo el envío clic aquí :</a>
                                        </label> 
                                    </div>
                                </div>
                              </form>
