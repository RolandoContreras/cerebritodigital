                     ...
                     <!--CREATE MODAL-->
                      <div class="modal text-center" id="modal_<?php echo $value->kit_id;?>">
                          <div class="onboarding-media" style="padding-top: 20px;">
                            <h4 class="onboarding-title" id="modalMsgTitle">PAGAR RECOMPRA</h4>
                          </div>
                          <div class="onboarding-content with-gradient">
                            <div class="onboarding-text" id="modalMsgBody">
                              <form > 
                                <div class="form-group"> <br>
                                  <div class="col-lg-12"> <label class="control-label"><br>Valor total:</label> <b><h3 style="font-weight: 900 !important">S/. <?php echo $value->price;?></h3></b> </div>
                                </div>
                                ...
                                <div class="form-group"> 
                                    <div class="col-lg-12"> 
                                        <label class="control-label"><br/>
                                            <a onclick='create_invoice_recompra("<?php echo $value->kit_id;?>","<?php echo $value->price;?>");' <?php echo $kit_id >= $value->kit_id?"disabled":"";?> style="cursor: pointer;  color: rgb(0,0,255);" >Si ya realizo el envío clic aquí :</a>
                                        </label> 
                                    </div>
                                </div>
                              </form>
                                ...
                                <div class="plan-price-w">
                                  ...
                                  <div class="plan-btn-w"> 
                                      <a href="#modal_<?php echo $value->kit_id;?>" rel="modal:open">
                                          <button  class="mr-2 mb-2 btn btn-warning"> Selecionar Pack</button>
                                      </a> 
                                  </div>
                              </div>
...
<script src="<?php echo site_url().'static/backoffice/js/script/recompra.js';?>"></script>
