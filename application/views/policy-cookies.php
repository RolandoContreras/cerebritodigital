          ...
          <div class="breadcrumb-content ">
            <div class="breadcrumbs-wrapper container">
              <ul id=breadcrumbs class=breadcrumbs>
                ...
                <li><span title="Acerca">Política de privacidad y Cookies</span></li>
              </ul>
            </div>
          </div>
        </div>
                                    ...
                                    <ul class="loop-item-0 bbp-forum-status-open bbp-forum-visibility-publish odd post-4289 forum type-forum status-publish hentry pmpro-has-access">
                                        <li class="bbp-forum-info" style="width: 100%;">
                                          ...
                                          <div class="bbp-forum-content">
                                              El presente Política de Privacidad establece los términos en que Cerebrito Digital usa y protege la información que es proporcionada por sus usuarios al momento de utilizar su sitio web. Esta compañía está comprometida con la seguridad de los datos de sus usuarios. Cuando le pedimos llenar los campos de información personal con la cual usted pueda ser identificado, lo hacemos asegurando que sólo se empleará de acuerdo con los términos de este documento. Sin embargo esta Política de Privacidad puede cambiar con el tiempo o ser actualizada por lo que le recomendamos y enfatizamos revisar continuamente esta página para asegurarse que está de acuerdo con dichos cambios.
                                        </div>
                                     </li>
                                    </ul>
                                </li>
                                    ...
                                    <ul class="loop-item-0 bbp-forum-status-open bbp-forum-visibility-publish odd post-4289 forum type-forum status-publish hentry pmpro-has-access">
                                        <li class="bbp-forum-info" style="width: 100%;">
                                          ...
                                          <div class="bbp-forum-content">
                                                ...
                                                Cerebrito Digital está altamente comprometido para cumplir con el compromiso de mantener su información segura. Usamos los sistemas más avanzados y los actualizamos constantemente para asegurarnos que no exista ningún acceso no autorizado.
                                          </div>
                                     </li>
                                    </ul>
                                </li>
                                    ...
                                    <ul class="loop-item-0 bbp-forum-status-open bbp-forum-visibility-publish odd post-4289 forum type-forum status-publish hentry pmpro-has-access">
                                        <li class="bbp-forum-info" style="width: 100%;">
                                          ...
                                          <div class="bbp-forum-content">
                                              ...
                                              <br/>
                                              Cerebrito Digital Se reserva el derecho de cambiar los términos de la presente Política de Privacidad en cualquier momento.
                                        </div>
                                     </li>
                                    </ul>
                                </li>
